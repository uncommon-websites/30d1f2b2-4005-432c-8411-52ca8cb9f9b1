		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
			...
			<div class="lg:col-span-2">
				<a href="/" class="text-xl font-bold tracking-tight flex items-center gap-2 mb-4">
					<svg width="24" height="30" viewBox="0 0 90 115" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-foreground">
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="mailto:hello@infinityforge.ai" class="hover:text-foreground">hello@infinityforge.ai</a></li>
				</ul>
			</div>

			<!-- Services -->
			<div>
				<h4 class="font-mono text-xs uppercase text-muted mb-4">Services</h4>
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="#" class="hover:text-foreground">Venture Studio</a></li>
					<li><a href="#" class="hover:text-foreground">Technical Co-Founding</a></li>
					<li><a href="#" class="hover:text-foreground">AI R&D Lab</a></li>
					<li><a href="#" class="hover:text-foreground">CTO-as-a-Service</a></li>
					<li><a href="#" class="hover:text-foreground">Research Partnerships</a></li>
					<li><a href="#" class="hover:text-foreground">Advisory Services</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					...
					<li><a href="#" class="hover:text-foreground">Methodology</a></li>
					<li><a href="#" class="hover:text-foreground">Case Studies</a></li>
					<li><a href="#" class="hover:text-foreground">Research Papers</a></li>
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted mb-8">
					...
					<li><a href="#" class="hover:text-foreground">Ethics & Compliance</a></li>
					<li><a href="#" class="hover:text-foreground">Partner Program</a></li>
					<li><a href="#" class="hover:text-foreground">Trust & Security</a></li>
				</ul>
